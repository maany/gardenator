"""
Django settings for gardenator_backend project.
...
SECRET_KEY = 'django-insecure-*b$mfkyqg_jvglz-+g283b69d4wj2m$)s%%_e&r2eu6c3-t1d*'
...
ROOT_URLCONF = 'gardenator_backend.urls'
...
WSGI_APPLICATION = 'gardenator_backend.wsgi.application'
